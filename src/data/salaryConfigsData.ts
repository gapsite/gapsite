...
export const DEFAULT_EMPLOYEE_SALARY_CONFIGS: EmployeeAnnualSalaryConfig[] = [
  ...
  // 2025 Historical & Baseline Records (All Roles)
  {
    ...
    status: 'ACTIVE',
    notes: 'Penetapan Standar Remunerasi Tahun Anggaran 2025',
  ...
  },
  {
    ...
    effectiveDate: '2025-01-01',
    status: 'ACTIVE',
    notes: 'Standar Remunerasi Lead Assessor Tahun Anggaran 2025',
    createdAt: '2025-01-02T08:00:00.000Z',
    updatedAt: '2025-01-02T08:00:00.000Z',
    updatedBy: 'Chief Director',
  },
  {
    id: 'SALCFG-2025-usr-tech-01',
    employeeId: 'usr-tech-01',
    employeeName: 'Siti Rahmawati, S.Kom.',
    year: 2025,
    role: 'TECHNICAL_CONSULTANT',
    roleTitle: 'Technical Consultant / BOM Specialist',
    department: 'Technical & TKDN Calculations',
    basicSalary: 8_750_000,
    positionAllowance: 1_800_000,
    transportAllowance: 900_000,
    mealAllowance: 750_000,
    communicationAllowance: 200_000,
    fixedAllowance: 0,
    annualBonusEstimate: 12_500_000,
    thrMonths: 1,
    bpjsKesehatanPercentage: 1,
    bpjsTkPercentage: 2,
    skNumber: 'SK-DIR/003/REMUN-TECH/2025',
    effectiveDate: '2025-01-01',
    status: 'ACTIVE',
    notes: 'Standar Remunerasi Technical Consultant Tahun Anggaran 2025',
    createdAt: '2025-01-02T08:00:00.000Z',
    updatedAt: '2025-01-02T08:00:00.000Z',
    updatedBy: 'Chief Director',
  },
  {
    id: 'SALCFG-2025-usr-survey-01',
    employeeId: 'usr-survey-01',
    employeeName: 'Hendra Wijaya, S.T.',
    year: 2025,
    role: 'SURVEYOR_LIAISON',
    ...
    positionAllowance: 1_250_000,
    transportAllowance: 1_100_000,
    mealAllowance: 750_000,
    communicationAllowance: 200_000,
    fixedAllowance: 0,
    annualBonusEstimate: 10_000_000,
    thrMonths: 1,
    bpjsKesehatanPercentage: 1,
    bpjsTkPercentage: 2,
    skNumber: 'SK-DIR/004/REMUN-SURVEY/2025',
    effectiveDate: '2025-01-01',
    status: 'ACTIVE',
    notes: 'Standar Remunerasi Surveyor Liaison Tahun Anggaran 2025',
    createdAt: '2025-01-02T08:00:00.000Z',
    updatedAt: '2025-01-02T08:00:00.000Z',
    updatedBy: 'Chief Director',
  },
  {
    id: 'SALCFG-2025-usr-fin-01',
    employeeId: 'usr-fin-01',
    employeeName: 'Dewi Lestari, S.E.',
    year: 2025,
    role: 'FINANCE_OFFICER',
    ...
    bpjsKesehatanPercentage: 1,
    bpjsTkPercentage: 2,
    skNumber: 'SK-DIR/005/REMUN-FIN/2025',
    effectiveDate: '2025-01-01',
    status: 'ACTIVE',
    notes: 'Standar Remunerasi Finance Officer Tahun Anggaran 2025',
    createdAt: '2025-01-02T08:00:00.000Z',
    updatedAt: '2025-01-02T08:00:00.000Z',
    updatedBy: 'Chief Director',
  },
...
export const getEffectiveSalaryConfig = (
  ...
  const exact =
    configs.find((c) => c.employeeId === employeeId && Number(c.year) === Number(year) && c.status !== 'ARCHIVED') ||
    configs.find((c) => c.employeeId === employeeId && Number(c.year) === Number(year));
  if (exact) {
    return {
      config: exact,
